...
export default function UserDashboard() {
  ...
  const translateText = async () => {
    ...
    try {
      ...
      if (targetLanguage === 'Nihongo' || targetLanguage === 'Hangugeo' || targetLanguage === 'Mandarin') {
                ...
                <div className="bg-[#F2F4FA] rounded-3xl p-6">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      >
                        <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 14.142M8.464 8.464a5 5 0 717.072 0M6.636 6.636a9 9 0 0112.728 0" />
                        </svg>
                      </button>
                    </div>
                    <button 
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <div className="flex items-center space-x-3">
                      ...
                      {isListening && <span className="text-red-500 text-sm">Listening...</span>}
                    </div>
